...
A personal agent toolkit for technical designers spanning a variety of different machine learning, software engineering, design, and realtime 3D use-cases (particularly Unreal Engine 5). Clone it anywhere, open Claude Code, tell it what you need — it extracts existing tooling to target projects and creates new Claude Code artifacts with consistent standards.
